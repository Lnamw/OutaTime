...
- (void)viewDidLoad
{
    ...
    //self.presentTimeLabel.text = stringFromDate;
    self.presentTimeLabel.text = [formatter stringFromDate:currentDate];
    ...
    self.speedLabel.text = [NSString stringWithFormat:@"%ld MPH", (long)speed];
